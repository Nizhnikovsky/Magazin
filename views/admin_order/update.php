            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <p>Город доставки</p>
                        <input type="text" name="delivery" placeholder="" value="<?php echo $order['delivery']; ?>">
                        <p>Адресс доставки</p>
                        <input type="text" name="adress" placeholder="" value="<?php echo $order['adress']; ?>">
                        <p>Почтовый индекс</p>
                        <input type="text" name="post_id" placeholder="" value="<?php echo $order['post_id']; ?>">
