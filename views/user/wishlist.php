                            ...
                            <tr>
                                ...
                                <td class="sop-cart an-sh">
                                    ...
                                    <div class="last-cart l-mrgn">
                                        <a class="las4" href="#">Быстрый промотр</a>
                                    </div>
                                </td>
                                <td class="sop-cart">
                                ...
                                <td class="cen">
                                    <span class="wishlist-in-stock">Распродажа</span>
                                </td>
                                <td class="sop-cart">
                                    <div class="last-cart l-mrgn wish">
                                        <a class="las4" href="#"> В корзину</a>
                                    </div>
                                </td>
                            </tr>
                            <tfoot>
                            <tr>
                                <td colspan="6">
                                    <div class="yith-wcwl-share">
                                        ...
                                        <ul>
                                            <li><a href="#"><img src="/template/img/icon-img/facebook.png" alt=""></a></li>
                                            <li><a href="#"><img src="/template/img/icon-img/twitter.png" alt=""></a></li>
                                            <li><a href="#"><img src="/template/img/icon-img/pinterest.jpg" alt=""></a></li>
                                            <li><a href="#"><img src="/template/img/icon-img/googleplus.jpg" alt=""></a></li>
                                            <li><a href="#"><img src="/template/img/icon-img/email.jpg" alt=""></a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
