            ...
            <div class="main-slider an-si">
                <div class="bend niceties preview-2 hm-ver-1">
                    <div id="ensign-nivoslider-2" class="slides">	
                        <img src="/template/img/slider/33.jpg" alt="" title="#slider-direction-3"  />
                        <img src="/template/img/slider/12.jpg" alt="" title="#slider-direction-1"  />
                    </div>
                    <!-- direction 1 -->
                    <div id="slider-direction-3" class="t-cn slider-direction Builder">
                        <div class="slide-all">
                            <!-- layer 1 -->
                            <div class="layer-1">
                                <h2 class="title5">Новая Коллекция</h2>
                            </div>
                            <!-- layer 2 -->
                            <div class="layer-2">
                                <h2 class="title6">Мужской одежды</h2>
                            </div>
                            <!-- layer 2 -->
                            <div class="layer-2">
                                <p class="title0">Скидки до 40%</p>
                            </div>
                            <!-- layer 3 -->
                            <div class="layer-3">
                                <a class="min1" href="#">Купить сейчас</a>
                            </div>
                        </div>
                    </div>
                    <div id="slider-direction-1" class="t-cn slider-direction Builder">
                        <div class="slide-all slide2">
                            ...
                            <!-- layer 2 -->
                            <div class="layer-2">
                                <h2 class="title6">Женской одежды</h2>
                            </div>
                            <!-- layer 2 -->
                            <div class="layer-2">
                                <p class="title0">Скидки до 40%</p>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="banner-box banner-box-re">
                                <a href="#">
                                    <img alt="" src="/template/img/banner/j1.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
                            ...
                            <div class="banner-box res-btm">
                                <a href="#">
                                    <img alt="" src="/template/img/banner/j2.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="banner-container banner-box res-btm">
                                <a href="#">
                                    <img alt="" src="/template/img/banner/cetr.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="banner-box banner-box-re">
                                <a href="#">
                                    <img alt="" src="/template/img/banner/j3.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
                            ...
                            <div class="banner-box">
                                <a href="#">
                                    <img alt="" src="/template/img/banner/j4.jpg">
                                    <div>
                                        <h2>
                                            Dynamic
                                            <span>Jazz</span>
					...
					<div class="col-xs-12">
						<div class="product-tab nav nav-tabs">
							<ul>                                        
								...
								<li><a data-toggle="tab" href="#clothings">одежда</a></li>
								<li><a data-toggle="tab" href="#shoes">обувь</a></li>
								<li><a data-toggle="tab" href="#bags">сумки</a></li>
								<li><a data-toggle="tab" href="#accessories">аксессуары</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div id="tab-carousel-1" class="re-owl-carousel owl-carousel product-slider owl-theme">
							<div class="col-xs-12">
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="/template/img/products/3.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/4.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="/template/img/products/5.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/6.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="/template/img/products/7.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/8.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="/template/img/products/9.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/10.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="/template/img/products/14.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/12.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="/template/img/products/15.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/14.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="/template/img/products/2.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/1.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="/template/img/products/4.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/3.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="/template/img/products/11.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/12.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
						...
						<div id="tab-carousel-2" class="owl-carousel product-slider owl-theme">
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="/template/img/products/12.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/11.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="/template/img/products/8.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/7.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="/template/img/products/14.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/13.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="/template/img/products/11.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/15.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="/template/img/products/10.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/9.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								<div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="/template/img/products/6.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/7.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        <a href="#">
                                            <img src="/template/img/products/4.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/5.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                                        <h3><a href="#">Product Title</a></h3>
							...
							<div class="col-xs-12">
								...
								<div class="single-product margin-top">
                                    <div class="product-img">
                                        ...
                                        <a href="#">
                                            <img src="/template/img/products/13.jpg" alt="Product Title" />
                                            <img class="secondary-image" alt="Product Title" src="/template/img/products/15.jpg">
                                        </a>
                                    </div>
                                    <div class="product-dsc">
                            ...
                            <div id="testimonials" class="re-owl-carousel2 owl-carousel product-slider owl-theme">
                                <div class="single-testimonial">
                                    ...
                                    <div class="testimonial-img">
                                        <a href="#"><img src="/template/img/testimonial/1.png" alt="Title" /></a>
                                ...
                                <div class="single-testimonial">
                                    ...
                                    <div class="testimonial-img">
                                        <a href="#"><img src="/template/img/testimonial/2.png" alt="Title" /></a>
                                        <h4><a href="#">Raymond Morales</a></h4>
                                        <span>chairman</span>
                                    </div>
                                </div>
                                ...
                                <div class="single-testimonial">
                                    ...
                                    <div class="testimonial-img">
                                        <a href="#"><img src="/template/img/testimonial/3.png" alt="Title" /></a>
                                        <h4><a href="#">Raymond Morales</a></h4>
                                        <span>chairman</span>
                                    </div>
                                </div>
				...
				<div class="row">
					<div id="blog" class="owl-carousel product-slider owl-theme re-blog">
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                <div class="post-thumb">
                                    <a href="#"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="/template/img/blog/111.jpg"></a>
                                </div>
						...
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                <div class="post-thumb">
                                    <a href="#"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="/template/img/blog/222.jpg"></a>
                                </div>
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <a href="#"> 75 of Ralph Laurenӳ</a>
						...
						<div class="col-xs-12">
							<div class="blog-container-inner">
                                <div class="post-thumb">
                                    <a href="#"><img class="attachment-blog-list wp-post-image" alt="blog-2" src="/template/img/blog/333.jpg"></a>
                                </div>
                                <div class="visual-inner">
                                    <h2 class="blog-title">
                                        <a href="#"> 75 of Ralph Laurenӳ</a>
